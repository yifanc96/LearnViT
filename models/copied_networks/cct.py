...
from ..copied_layers.transformers import TransformerClassifier, MaskedTransformerClassifier
from ..copied_layers.tokenizer import Tokenizer, TextTokenizer
from ..copied_layers.embedder import Embedder
...
class CCT(nn.Module):
    def __init__(self,
                 ...
                 pooling_stride=2,
                 pooling_padding=1, 
                 drop_rate=0., attn_drop_rate=0.1,
                 drop_path_rate = 0.1, layerscale = 0.0,
                 num_classes = 100,
                 mlp_ratio=2,
                 num_heads = 4,
                 *args, **kwargs):
