...
def trainer(model, train_dataloader, device, optimizer, criterion, nepochs, nepochs_save, save_path, test_dataloader=None):
    train_accs = []
    test_accs = [] if test_dataloader is not None else None
    
    for epoch in range(nepochs):
        running_loss, running_accuracy = train(model, train_dataloader, criterion, optimizer, device)
